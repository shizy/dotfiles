...
hi Pmenu                    ctermfg=201 ctermbg=232 cterm=none
hi PmenuSel                 ctermfg=232 ctermbg=200 cterm=bold
...
hi SignifySignChangeDelete  ctermfg=2000 ctermbg=none cterm=bold
